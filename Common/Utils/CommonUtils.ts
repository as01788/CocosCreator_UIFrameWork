...
import { EventTouch, Label, loader, Node, rect, Sprite, SpriteFrame, UITransform, Vec2, view } from "cc";
...
export class CommonUtils {
    ...
    public static async httpGet(url: string, cb) {
        ...
        //xhr.setRequestHeader('Authorization', 'Bearer ' + myGame.gameManager.getToken());
